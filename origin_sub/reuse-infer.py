...
parser.add_argument('--out_dir', type=str, required=True, help="Path to the training data directory")
...
parser.add_argument('--overlapxy', type=int, default=16, help="Number of training epochs")
parser.add_argument('--overlapz', type=int, default=4, help="Number of training epochs")
parser.add_argument('--resolution_z', type=int, default=10, help="Number of training epochs")
parser.add_argument('--patch_size_xy', type=int, default=256, help="Number of training epochs")
parser.add_argument('--patch_size_z', type=int, default=31, help="Number of training epochs")
